                                    ...
                                    <div className="mb-3">
                                        ...
                                        <InputGroup className="has-validation">
                                            ...
                                            <Button variant="light" onClick={toggleVisibilityPassword}>
                                                {visiblePassword ? (<i className="ri-eye-line align-middle"></i>) : (<i className="ri-eye-off-line align-middle"></i>)}
                                            </Button>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <InputGroup className="has-validation">
                                            ...
                                            <Button variant="light" onClick={toggleVisibilityConfirmPassword}>
                                                {visibleConfirmPassword ? (<i className="ri-eye-line align-middle"></i>) : (<i className="ri-eye-off-line align-middle"></i>)}
                                            </Button>
