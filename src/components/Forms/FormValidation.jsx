...
const Formvalidation = () => {
    ...
    const handleSelectChange = (event) => {
        ...
        setIsValid(value !== ''); // You can add your specific validation logic here
    };

    return (
        <Fragment>
            <Pageheader heading="Form-validation" homepage="Forms" activepage='Form-validation' />
                            ...
                            <Card.Body>
                                <div className="card-area">
                                    <Form className="was-validated">
                                        ...
                                        <Form.Group className="mb-3">
                                            <select className={`form-control ${isValid ? 'is-valid' : 'is-invalid'}`} value={selectedValue} onChange={handleSelectChange} required aria-label="select example" >
                                            ...
                                            <Form.Control.Feedback type={isValid ? 'valid' : 'invalid'}>
                                                {isValid ? null : 'Example invalid select feedback'}
                                            </Form.Control.Feedback>
                                        </Form.Group>
                                        <div className="mb-3">
